...
#25
#--------------------------------------------------------------------------------
def matrix_filling_input_25(matrix): # заполнение матрицы смежности
    print('====================Свойства графа:======================')
    print('1)Двудольный')
    f.write('====================Свойства графа:======================\n')
    f.write('1)Двудольный\n')
    for i in range(row):
        array = []
        for j in range(column):
...
def sample(path):
    ...
    elif (path[0] == '2') and (path[1] == '5'):
        matrix_filling_input_25(mat)#25
    print_matrix(mat)
